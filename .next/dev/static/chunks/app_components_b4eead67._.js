            ...
            try {
                ...
                if (totalPages > 1) {
                    const pages = Array.from({
                        ...
                        "SearchOverlay.useCallback[search].pages": (_, i)=>i + 2
                    }["SearchOverlay.useCallback[search].pages"]);
                    const rest = await Promise.all(pages.map({
                        "SearchOverlay.useCallback[search]": (p)=>fetch(`${API}/ranches/${getSlug()}/animals?limit=50&page=${p}`, {
                                headers: {
                                    Authorization: `Bearer ${getToken()}`
                                }
                            }).then({
                                "SearchOverlay.useCallback[search]": (r)=>r.ok ? r.json() : null
                            }["SearchOverlay.useCallback[search]"])
                    }["SearchOverlay.useCallback[search]"]));
                    rest.forEach({
                        "SearchOverlay.useCallback[search]": (j)=>{
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                ...
                canScan && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s2(MobileShell, "2hEUvzoIISrPcfKFmR3lPRPKX6s=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$context$2f$AuthContext$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"]
    ];
});
...
//# sourceMappingURL=app_components_b4eead67._.js.map