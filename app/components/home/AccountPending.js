...
const AccountPending = () => {
  ...
  return (
    <section className=" relative w-full h-175 flex justify-center items-center">
      <div className="flex flex-col items-center gap-5">
        ...
        <p className="w-full md:w-140 text-center space-x-0.5 font-extralight">
          ...
          or decline access shortly. Kindly <Link href={"/"} className="underline text-red-900">login</Link> to
          check if you have ben granted access
        </p>
